...
public class BlobStreamProxyPrototype extends KrollProxyPrototype
{
	private static final long serialVersionUID = 59332654752767861L;

	private static final String TAG = "BlobStreamProxyPrototype";
	private static final String CLASS_TAG = "BlobStreamProxy";
	private static BlobStreamProxyPrototype blobStreamProxyPrototype;


	public static BlobStreamProxyPrototype getProxyPrototype()
	{
		return blobStreamProxyPrototype;
	}

	public static void dispose()
	{
		Log.d(TAG, "dispose()", Log.DEBUG_MODE);
		blobStreamProxyPrototype = null;
	}

	public BlobStreamProxyPrototype()
	{
		if (blobStreamProxyPrototype == null && getClass().equals(BlobStreamProxyPrototype.class)) {
			blobStreamProxyPrototype = this;
	...
	{
		if (this == blobStreamProxyPrototype) {
	...
	{
		return KrollProxy.createProxy(BlobStreamProxy.class, getRhinoObject(), args, creationUrl);
	}
	...
	public Object write(Context context, Scriptable thisObj, Object[] args)
	{
		...
		try {
		BlobStreamProxy proxy = (BlobStreamProxy) ((Proxy) thisObj).getProxy();
...
// #/string_id_map#
		...
		Context cx, Scriptable scope, Scriptable thisObj, Object[] args)
	{
		...
		while (thisObj != null && !(thisObj instanceof BlobStreamProxyPrototype)) {
			thisObj = thisObj.getPrototype();
		}

		BlobStreamProxyPrototype proxy = (BlobStreamProxyPrototype) thisObj;
		int id = f.methodId();
		switch (id) {
			case Id_constructor:
