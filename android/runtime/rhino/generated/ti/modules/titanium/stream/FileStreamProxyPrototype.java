...
public class FileStreamProxyPrototype extends KrollProxyPrototype
{
	private static final long serialVersionUID = 5394857740133354602L;

	private static final String TAG = "FileStreamProxyPrototype";
	private static final String CLASS_TAG = "FileStreamProxy";
	private static FileStreamProxyPrototype fileStreamProxyPrototype;


	public static FileStreamProxyPrototype getProxyPrototype()
	{
		return fileStreamProxyPrototype;
	}

	public static void dispose()
	{
		Log.d(TAG, "dispose()", Log.DEBUG_MODE);
		fileStreamProxyPrototype = null;
	}

	public FileStreamProxyPrototype()
	{
		if (fileStreamProxyPrototype == null && getClass().equals(FileStreamProxyPrototype.class)) {
			fileStreamProxyPrototype = this;
	...
	{
		if (this == fileStreamProxyPrototype) {
	...
	{
		return KrollProxy.createProxy(FileStreamProxy.class, getRhinoObject(), args, creationUrl);
	}
	...
	public Object write(Context context, Scriptable thisObj, Object[] args)
	{
		...
		try {
		FileStreamProxy proxy = (FileStreamProxy) ((Proxy) thisObj).getProxy();
...
// #/string_id_map#
		...
		Context cx, Scriptable scope, Scriptable thisObj, Object[] args)
	{
		...
		while (thisObj != null && !(thisObj instanceof FileStreamProxyPrototype)) {
			thisObj = thisObj.getPrototype();
		}

		FileStreamProxyPrototype proxy = (FileStreamProxyPrototype) thisObj;
		int id = f.methodId();
		switch (id) {
			case Id_constructor:
